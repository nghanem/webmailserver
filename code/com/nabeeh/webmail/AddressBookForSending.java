...
public class AddressBookForSending extends Page {
	/**
	...
	*/
	...
	public AddressBookForSending(HttpServletRequest request, HttpServletResponse response) throws IOException  {
	...
	public void body() {
		...
		StringTemplate bodyST = templates.getInstanceOf("addressBook");
