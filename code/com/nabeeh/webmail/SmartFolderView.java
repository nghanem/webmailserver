...
public class SmartFolderView extends Page {
	/**
	...
	*/
    ...
    public SmartFolderView(HttpServletRequest request, HttpServletResponse response) throws IOException  {
    ...
    public void body() {
        ...
        StringTemplate bodyST = templates.getInstanceOf("smartFolderView");
        ...
        while (iterSmartFolder.hasNext()) {
            ...
            bodyST.setAttribute("modifiedFolder", sFolder);
        }
